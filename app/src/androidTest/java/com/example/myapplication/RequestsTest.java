...
public class RequestsTest {
    ...
    @Test
    public void clickOnRequests() throws InterruptedException {
        login1();
        sleep(1000);
    ...
    @Test
    public void seeRequest() throws InterruptedException {
        login1();
        sleep(1000);
        onView(withText("Requests")).perform(click());
        onView(withText("exampleOrignal")).check(matches(isDisplayed()));
        signUserOut();
    }
    ...
    public void acceptRequest() throws InterruptedException {
        ...
        sleep(1000);
        onView(withText("New contact successfully added")).check(matches(isDisplayed()));
        signUserOut();
    }
    ...
    public void declineRequest() throws InterruptedException {
        ...
        sleep(1000);
        onView(withText("Request Declined")).check(matches(isDisplayed()));
        signUserOut();
